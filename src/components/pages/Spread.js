...
const Spread = () =>{
    const datas = useApi('/spread-betting/');
    const title = 'Top 10 Best Spread Betting Platforms In UK';
    const parag = `<h3>We listed the best spread betting brokers in the market</h3><br>
                    <ul>
